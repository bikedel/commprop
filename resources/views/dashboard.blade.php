...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container w3-section">
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-third">
        <h5>Regions</h5>
        <img src="http://maps.googleapis.com/maps/api/staticmap?size=100x240&markers=-33,18&maptype=hybrid&scale=2&zoom=12&sensor=false" style="width:100%" alt="Google Regional Map">
        <img src = "{{public_path()}}/img/sothebys_logo_big_blue.jpg" style="width:100%"/>
      </div>
