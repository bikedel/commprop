...
-->
                        ...
                        <button class="btn btn-success " @click.prevent="resetSearch()">Reset</button><p v-if="searching == true" style="color:white;"><i class="fa fa-refresh fa-spin fa-3x fa-fw" aria-hidden="true"></i>Searching...</p>
