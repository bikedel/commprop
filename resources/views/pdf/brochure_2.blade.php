...
<img align="center" src = "http://maps.googleapis.com/maps/api/staticmap?size=600x200&zoom=16&markers=icon:http://www.sircommdb.co.za/marker32_' . {{$loop->index+1}} . '.png%7Clabel:{{$loop->index+1}}%7C{{$item->long}},{{$item->lat}}&maptype=hybrid&scale=20&sensor=false&label=Hello&key=AIzaSyCNgTdT8SN3jIzbdvZu7CBPKw3zz8J4Pww"  width="740" height="200" class='prop_img 'alt='Google Map'/>
