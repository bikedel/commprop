        ...
        foreach ($properties as $property) {
            ...
            if ($property->long && $property->lat) {
                ...
                if ($property->sale_type_id == 2) {
                    Mapper::marker($property->long, $property->lat, ['dragable' ==> 'true', , 'eventAfterLoad' => 'eventAfterLoad(event);', 'title' => 'Type: ' . $types[$property->type] . ' Erf: ' . $property->erf, 'eventRightClick' => 'console.log("right click");', 'content' => $content . '<br> <img src=' . $image . '  style="width:120px;" />', 'scale' => 13, 'animation' => 'DROP', 'icon' => "http://maps.google.com/mapfiles/ms/icons/green-dot.png"]);
