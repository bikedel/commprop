...
<img align="center" src = "http://maps.googleapis.com/maps/api/staticmap?size=600x200&zoom=16&markers=icon:http://www.sircommdb.co.za/marker32_{{$loop->index+1}}.png%7C{{$item->long}},{{$item->lat}}&maptype=hybrid&scale=2&key=AIzaSyCNgTdT8SN3jIzbdvZu7CBPKw3zz8J4Pww"  width="740" height="200" class='prop_img 'alt='Google Map'/>
...
<footer class="w3-container w3-light-grey">
    ...
    @if(strlen($note)>0 )
      <p class="w3-text-black"><b>Note: </b>  {{$note}} </p>
    @endif
